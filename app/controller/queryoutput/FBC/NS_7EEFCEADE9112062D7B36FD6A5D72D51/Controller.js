Ext.define('Form.controller.queryoutput.FBC.NS_7EEFCEADE9112062D7B36FD6A5D72D51.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_7EEFCEADE9112062D7B36FD6A5D72D51.View'],
   	models: ['queryoutput.FBC.NS_7EEFCEADE9112062D7B36FD6A5D72D51.Model'],
   	stores: ['queryoutput.FBC.NS_7EEFCEADE9112062D7B36FD6A5D72D51.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_7EEFCEADE9112062D7B36FD6A5D72D51 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_7EEFCEADE9112062D7B36FD6A5D72D51': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform151AAB0A-D39D-0D2D-B6E2FA149E68DB7F',
				    	autoScroll: true,
				    	items: [{
							width: '95%',name: 'eginpmsrater-RATERCODE',
							fieldLabel: 'Rater Code',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'eginpmsrater-PMSCODEFK',
							fieldLabel: 'PMS Code Fk',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'eginpmsrater-RATERPID',
							fieldLabel: 'Rater PID',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'egrgmyibose-PERSONNELIDNO',
							fieldLabel: 'My Personnel ID',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'egrgmyibose-USERID',
							fieldLabel: 'My User ID',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'gmfpeople-FIRSTNAME',
							fieldLabel: 'First Name',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'gmfpeople-LASTNAME',
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_7EEFCEADE9112062D7B36FD6A5D72D51');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Rater';
					var qrycode = '7EEFCEAD-E911-2062-D7B36FD6A5D72D51';
					Ext.NS_7EEFCEADE9112062D7B36FD6A5D72D51.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_7EEFCEADE9112062D7B36FD6A5D72D51.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '7EEFCEAD-E911-2062-D7B36FD6A5D72D51';
   			Ext.NS_7EEFCEADE9112062D7B36FD6A5D72D51.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform151AAB0A-D39D-0D2D-B6E2FA149E68DB7F') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
