Ext.define('Form.controller.queryoutput.FBC.NS_48CE9210F7788560FFBD7697C62E54F8.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_48CE9210F7788560FFBD7697C62E54F8.View'],
   	models: ['queryoutput.FBC.NS_48CE9210F7788560FFBD7697C62E54F8.Model'],
   	stores: ['queryoutput.FBC.NS_48CE9210F7788560FFBD7697C62E54F8.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_48CE9210F7788560FFBD7697C62E54F8 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_48CE9210F7788560FFBD7697C62E54F8': {
   		...
   		initPanel: function(b) {
			...
			var dw = Ext.create('Ext.window.Window', {
			    ...
			    items: [{
			    	xtype: 'form',
			    	id: 'viewform5100063E-F46C-804A-F85A52934684F322',
			    	autoScroll: true,
			    	items: [{
						 ...
						 xtype: 'numberfield'}]
						    ...
						    buttons: [{
						    	...
						    	handler: function(em) {
						    		...
						    		if (dform.isValid()) {
						    			var dgrid = Ext.widget('NS_48CE9210F7788560FFBD7697C62E54F8');
		...
		var df = fwin.down('form').getForm();
		    	...
		    	dgrid.getStore().remove(seldata);
					...
					var qrytitle = 'Row Body and Expander';
					var qrycode = '48CE9210-F778-8560-FFBD7697C62E54F8';
					Ext.NS_48CE9210F7788560FFBD7697C62E54F8.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
						    ...
						    buttons: [{
						    	...
						    	handler: function(em) {
						    		...
						    		if (dform.isValid()) {
							    		...
							    		Ext.NS_48CE9210F7788560FFBD7697C62E54F8.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
							    			dwin.getEl().unmask();
							    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '48CE9210-F778-8560-FFBD7697C62E54F8';
   			Ext.NS_48CE9210F7788560FFBD7697C62E54F8.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform5100063E-F46C-804A-F85A52934684F322');
   			if (formCmp) {
