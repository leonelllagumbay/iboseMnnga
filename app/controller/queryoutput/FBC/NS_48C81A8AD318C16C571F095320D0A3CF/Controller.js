Ext.define('Form.controller.queryoutput.FBC.NS_48C81A8AD318C16C571F095320D0A3CF.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_48C81A8AD318C16C571F095320D0A3CF.View'],
   	models: ['queryoutput.FBC.NS_48C81A8AD318C16C571F095320D0A3CF.Model'],
   	stores: ['queryoutput.FBC.NS_48C81A8AD318C16C571F095320D0A3CF.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_48C81A8AD318C16C571F095320D0A3CF button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_48C81A8AD318C16C571F095320D0A3CF': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform50766878-DE6E-4BFD-210012320803E5F8',
				    	autoScroll: true,
				    	items: [{
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_48C81A8AD318C16C571F095320D0A3CF');
		    	...
		    	dgrid.getStore().remove(seldata);
					...
					var qrytitle = 'Summary';
					var qrycode = '48C81A8A-D318-C16C-571F095320D0A3CF';
					Ext.NS_48C81A8AD318C16C571F095320D0A3CF.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_48C81A8AD318C16C571F095320D0A3CF.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '48C81A8A-D318-C16C-571F095320D0A3CF';
   			Ext.NS_48C81A8AD318C16C571F095320D0A3CF.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform50766878-DE6E-4BFD-210012320803E5F8') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
