Ext.define('Form.controller.queryoutput.FBC.NS_80C9F6FC90B74FB7FDF3B78C69508B26.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_80C9F6FC90B74FB7FDF3B78C69508B26.View'],
   	models: ['queryoutput.FBC.NS_80C9F6FC90B74FB7FDF3B78C69508B26.Model'],
   	stores: ['queryoutput.FBC.NS_80C9F6FC90B74FB7FDF3B78C69508B26.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_80C9F6FC90B74FB7FDF3B78C69508B26 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_80C9F6FC90B74FB7FDF3B78C69508B26': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform8EE21C3E-B3AB-D5F9-6135C033081C3165',
				    	autoScroll: true,
				    	items: [{
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_80C9F6FC90B74FB7FDF3B78C69508B26');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Dedicated Comments';
					var qrycode = '80C9F6FC-90B7-4FB7-FDF3B78C69508B26';
					Ext.NS_80C9F6FC90B74FB7FDF3B78C69508B26.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_80C9F6FC90B74FB7FDF3B78C69508B26.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '80C9F6FC-90B7-4FB7-FDF3B78C69508B26';
   			Ext.NS_80C9F6FC90B74FB7FDF3B78C69508B26.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform8EE21C3E-B3AB-D5F9-6135C033081C3165') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
