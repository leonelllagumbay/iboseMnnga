Ext.define('Form.controller.queryoutput.FBC.NS_7F51BEEEA06D8FF53401E9307A6E8030.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_7F51BEEEA06D8FF53401E9307A6E8030.View'],
   	models: ['queryoutput.FBC.NS_7F51BEEEA06D8FF53401E9307A6E8030.Model'],
   	stores: ['queryoutput.FBC.NS_7F51BEEEA06D8FF53401E9307A6E8030.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_7F51BEEEA06D8FF53401E9307A6E8030 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_7F51BEEEA06D8FF53401E9307A6E8030': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform4C789771-FF5D-0083-C46AF220C2765B47',
				    	autoScroll: true,
				    	items: [{
							width: '95%',name: 'eginpmsempkraitems-KRAITEMCODE',
							fieldLabel: 'No.',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
							...
							fieldLabel: 'Key Result Areas (KRA)',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							...
							fieldLabel: 'Key Performance Indicator or Standard',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'eginpmsempkraitems-WEIGHT',
							fieldLabel: 'Weight',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'eginpmsempkraitems-ACCOMPLISHMENTS',
							fieldLabel: 'Accomplishments',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'eginpmsempkraitems-RATING',
							fieldLabel: 'Rating',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'eginpmsempkraitems-WEIGHTEDRATING',
							fieldLabel: 'Weighted Rating',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'eginpmsempkraitems-COMMENTS',
							fieldLabel: 'Comments',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'eginpmsempkraitems-KRACODEFK',
							fieldLabel: 'KRA Code Fk',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'eginpmsempkraitems-KEYRESULTAREACODEFK',
							fieldLabel: 'Key Result Area Code Fk',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							...
							fieldLabel: 'Assessment Period From',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'eginpmsempkra-ASSESSMENTPERIODTO',
							fieldLabel: 'Assessment Period To',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_7F51BEEEA06D8FF53401E9307A6E8030');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Key Result Areas and Key Performance Indicators';
					var qrycode = '7F51BEEE-A06D-8FF5-3401E9307A6E8030';
					Ext.NS_7F51BEEEA06D8FF53401E9307A6E8030.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_7F51BEEEA06D8FF53401E9307A6E8030.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '7F51BEEE-A06D-8FF5-3401E9307A6E8030';
   			Ext.NS_7F51BEEEA06D8FF53401E9307A6E8030.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform4C789771-FF5D-0083-C46AF220C2765B47') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
