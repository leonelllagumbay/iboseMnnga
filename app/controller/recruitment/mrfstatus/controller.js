Ext.define('Form.controller.recruitment.mrfstatus.controller', {
	...
	hideshowrecord: function(sbutton, eOpts) {
		...
		if(menu0) {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'igroup') grid.columns[i].hidden = false;
			}
		} else {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'igroup') grid.columns[i].hidden = true;
			}
		}
		
		if(menu1) {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'agroup') grid.columns[i].hidden = false;
			}
		} else {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'agroup') grid.columns[i].hidden = true;
			}
		}
		
		if(menu2) {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'examgroup') grid.columns[i].hidden = false;
			}
		} else {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'examgroup') grid.columns[i].hidden = true;
			}
		}
		
		if(menu3) {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'hrgroup') grid.columns[i].hidden = false;
			}
		} else {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'hrgroup') grid.columns[i].hidden = true;
			}
		}
		
		if(menu4) {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'fdgroup') grid.columns[i].hidden = false;
			}
		} else {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'fdgroup') grid.columns[i].hidden = true;
			}
		}
		
		if(menu5) {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'dhgroup') grid.columns[i].hidden = false;
			}
		} else {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'dhgroup') grid.columns[i].hidden = true;
			}
		}
		
		if(menu6) {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'gmgroup') grid.columns[i].hidden = false;
			}
		} else {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'gmgroup') grid.columns[i].hidden = true;
			}
		}
		
		if(menu7) {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'jogroup') grid.columns[i].hidden = false;
			}
		} else {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'jogroup') grid.columns[i].hidden = true;
			}
		}
		
		if(menu8) {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'pecgroup') grid.columns[i].hidden = false;
			}
		} else {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'pecgroup') grid.columns[i].hidden = true;
			}
		}
		
		if(menu9) {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'cfgroup') grid.columns[i].hidden = false;
			}
		} else {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'cfgroup') grid.columns[i].hidden = true;
			}
		}
		
		if(menu10) {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'ocgroup') grid.columns[i].hidden = false;
			}
		} else {
			for (var i = 1; i < grid.columns.length; i++) {
				if (grid.columns[i].action == 'ocgroup') grid.columns[i].hidden = true;
			}
		}
